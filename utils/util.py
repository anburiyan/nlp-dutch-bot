...
def response_has_attribute_and_value(resp_data, attribute, value):
    ''' Check whether the bot response data has attribute and a particular value 
        Arguments:
    ...
    is_available = False
    for atr in resp_data:
        if atr[attribute] and atr[attribute] == value:
            is_available = True
            break
    # true if attr[attribute] and attr[attribute] == value for attr in resp_data else false
    return is_available